...
1. Navigate to the History tab.
   * Note: On launch, the system automatically generates a Randomized History from its internal database of 45 songs to simulate a unique user profile/listening history.
2. Navigate to the Recs tab and click "Get recommendations."
3. The Result: You will see 5 recommendation cards. 
